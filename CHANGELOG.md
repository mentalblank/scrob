...
- **Blur unwatched episode images**: Blur the still of any episode you have not watched. Click to reveal it.
- **Blur unwatched episode descriptions**: Blur the synopsis of any episode you have not watched. Click to reveal it.
- **Blur unwatched movie images**: Blur the backdrop of any movie you have not watched. Posters are left alone.
- **Blur unwatched movie descriptions**: Blur the synopsis of any movie you have not watched. Click to reveal it.
- **Image overrides**: Use alternative artwork from TMDB and TheTVDB, or any image URL. Only you see the change.
- **Timezone settings**: Timezone used for your watch history, the date on a newly logged play, and which episodes count as aired today. Only affects your account.
- **Admin Disable user ratings and ratings**: Hides ratings and comments from users of this app for everyone. TMDB ratings stay visible.
