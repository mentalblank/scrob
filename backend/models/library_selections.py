...
class JellyfinLibrarySelection(Base):
    ...
    __table_args__ = (UniqueConstraint("connection_id", "library_id"),)

    id            : Mapped[int] = mapped_column(Integer, primary_key=True)
    user_id       : Mapped[int] = mapped_column(Integer, ForeignKey("users.id", ondelete="CASCADE"), nullable=False)
    connection_id : Mapped[int] = mapped_column(Integer, ForeignKey("media_server_connections.id", ondelete="CASCADE"), nullable=False)
...
class PlexLibrarySelection(Base):
    ...
    __table_args__ = (UniqueConstraint("connection_id", "library_key"),)
